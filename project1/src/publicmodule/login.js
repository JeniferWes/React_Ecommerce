...
const MyLogin = () =>{
    ...
    const loginCheck=(obj)=>{
        obj.preventDefault();//it stops the default form behavior(stops refresh)
        ...
        .then(allaccount=>{
          ...
          if(success.length>0){
            ...
            window.location.reload();//It is used to refresh the page(Now App.js will load first and check conditions)
          }else{
