    ...
    return (
        <section className="container p-4">
            ...
            <div className="row mb-3">
                <div className="col-xl-9"> <h1 className="text-center mb-4">Product List</h1> </div>
            ...
            <table className="table table-bordered text-center align-middle">
                ...
                <tbody>
                    {itemList.slice(offset, offset + PER_PAGE).map((item, index) => {
                        //If condition will return true if the keyword is an empty string. If the user dint type in search, then it will show all the products.
